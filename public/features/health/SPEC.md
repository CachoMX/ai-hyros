...
**id** `health` · **mode** both (live + demo) · **version** 1.0.0
...
Each step is independent; failures append to `errors` and never fail the refresh.
...
`snapshot.account`, and the account's default attribution window.
